    ...
    return(
        ...
        <div className="dark:bg-black dark:text-white  min-h-screen   relative">
          <div
            ...
            style={{backgroundImage: `url(${Background_img})`,backgroundRepeat: "no-repeat",backgroundSize: "cover",rotate: "rotate(0deg)",}}></div>
          <div
            className="w-[100%] block lg:hidden md:block top-0 right-0 absolute h-full lg:w-1/2 md:w-[100%]"
            style={{backgroundImage: `url(${Background_img_mbl})`,backgroundRepeat: "no-repeat",backgroundSize: "contain",}}></div>
