...
import { AssetsPage } from "../../Dashboard/AssetsModules/Page";
...
export const LayOut = () => {
  ...
  const [activePage, setActivePage] = useState(Navigation[0].Content);
  return (
    <>
            ...
            <div className="mt-10">
              ...
              <div className="flex flex-col">
                {Navigation.map((item) => (
                  <button
                    key={item.id}
                    onClick={() => setActivePage(item.Content)}
                  ...
                  >
                    ...
                    <span className="group-hover:text-black text-Slate_Gray text-[14px] font-bold dark:group-hover:text-white">
                      {item.name}
                    </span>
                  </button>
                ))}
